...
if (isset($_POST['reg_user'])) {
  ...
  $user_check_query = "SELECT * FROM utilisateur WHERE username='$username' OR email='$email' LIMIT 1";
...
if (isset($_POST['save'])) {
  ...
  mysqli_query($db, "INSERT INTO info (name, address) VALUES ('$username', '$email')"); 
